...
const Question = require('../question'); // Adjust the path according to your folder structure
...
// Route to handle POST request to /api/questions/filter with JSON body parameters for filtering
router.post('/questions/filter', async (req, res) => {
  try {
    const { subject, chapter, difficulty, type, topic } = req.body;
