...
const questionRoutes = require('./routes/questions'); // Import the questions route
...
app.use('/api/questions', questionRoutes); // Use the questions route for /api/questions
